export default function Datenschutz() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
      <div className="max-w-2xl w-full p-6 md:p-12 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 my-8">
        {/* Backlink to Home */}
        <div className="mb-4">
        ...
        <ul className="space-y-1 max-w-md list-disc list-inside m-4">
          ...
          <li>
            <a className="hover:underline" href="#m27">Sicherheitsmaßnahmen</a>
          </li>
          <li>
