    ...
    <div>
      <div className="h-full w-full text-left p-10 items-center text-white bg-blue-600">
        ...
        <ul className="space-y-1 max-w-md list-disc list-inside m-4">
          ...
          <li>
            <a className="hover:underline" href="#mOverview">Übersicht der Verarbeitungen</a>
          </li>
          <li>
            <a className="hover:underline" href="#m13">Maßgebliche Rechtsgrundlagen</a>
          </li>
          <li>
          ...
          <li>
            <a className="hover:underline" href="#m317">Geschäftliche Leistungen</a>
          </li>
          <li>
          ...
          <li>
            <a className="hover:underline" href="#m10">Rechte der betroffenen Personen</a>
          </li>
          <li>
        ...
        Impressum:{" "}
        <p>
          <a className="hover:underline" href="https://www.yurtemre.de/impressum" target="_blank">
        ...
        <ul className="space-y-1 max-w-md list-disc list-inside m-4">
          <li>
            ...
            Registrierung eines Kundenkontos erforderlich ist, werden
