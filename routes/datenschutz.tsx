    ...
    <div>
      <nav className="p-4">
        <div className="flex justify-between items-center">
          ...
          <h2 className="font-bold text-center">Datenschutzerklärung</h2>
        </div>
      </nav>
      ...
      <div className="min-h-screen w-full flex flex-col items-center">
        <div className="max-w-2xl w-full p-6 md:p-12 rounded-lg my-8">
          ...
          <ul className="space-y-1 max-w-md list-disc list-inside m-4">
            <li>
              <a className="hover:underline" href="#m14">Einleitung</a>
            </li>
            <li>
              <a className="hover:underline" href="#m3">Verantwortlicher</a>
            </li>
            <li>
              <a className="hover:underline" href="#mOverview">
                Übersicht der Verarbeitungen
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m13">
                Maßgebliche Rechtsgrundlagen
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m27">
                Sicherheitsmaßnahmen
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m12">Löschung von Daten</a>
            </li>
            <li>
              <a className="hover:underline" href="#m317">
                Geschäftliche Leistungen
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m15">
                Änderung und Aktualisierung der Datenschutzerklärung
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m10">
                Rechte der betroffenen Personen
              </a>
            </li>
            <li>
              <a className="hover:underline" href="#m42">
          ...
          <p>
            <a
              ...
              href="https://www.yurtemre.de/impressum"
              target="_blank"
            >
          ...
          <ul className="">
            ...
            <li>
              ...
              lit. b) DSGVO; Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit.
              c) DSGVO; Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f)
              DSGVO.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1 max-w-md list-disc list-inside m-4">
            <li>
              ...
              anlegen (z.B. Kunden- bzw. Nutzerkonto, kurz "Kundenkonto"). Falls
              die Registrierung eines Kundenkontos erforderlich ist, werden
              ...
              Nutzungen des Kundenkontos speichern wir die IP-Adressen der
              ...
              sichern; <strong>Rechtsgrundlagen:</strong>{" "}
              Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
              lit. b) DSGVO).
            </li>
            <li>
              <strong>Projekt- und Entwicklungsleistungen:</strong>{" "}
              ...
              und vertraglichen Vorgaben; <strong>Rechtsgrundlagen:</strong>
              {" "}
              Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
              lit. b) DSGVO).
            </li>
          ...
          <ul className="space-y-1 max-w-md list-disc list-inside m-4">
            ...
            <li>
              ...
              und umfasst praktisch jeden Umgang mit Daten, sei es das Erheben,
